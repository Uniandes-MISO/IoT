...
const char MQTT_HOST[] = "54.82.31.246"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
...
void displayMeasures() {
  ...
  lcd.setCursor(0, 1);
  lcd.println("T: " + String(temp) + " H: " + String(humi) );
}
